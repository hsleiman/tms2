...
//                        callLogLeg.setAgentUserName(agentUserName);
     ...
     *  fromDate:   start date should be in timestamp format and its numeric (no millisecond: 10 digits) fromDate <= toDate  <br/>
     *  toDate:     end date should be in timestamp format and its numeric (no millisecond: 10 digits) <br/>
     ...
     *  "pageSize" : 100
     *  } </p>
     * @return CallDetailRecordResult contains total records number and  List of CallDetailRecord
