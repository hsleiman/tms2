...
import com.objectbrains.sti.constants.CallState;
import com.objectbrains.sti.constants.PreviewDialerType;
import com.objectbrains.sti.embeddable.CustomerTMSInfo;
...
public class AgentCall implements DataSerializable {
    ...
    private CustomerTMSInfo borrowerInfo;
    ...
    public AgentCall(String callUUID, PreviewDialerType previewType, boolean ignoreWrap,
            CustomerTMSInfo borrowerInfo, CallDirection callDirection,
    ...
    public CustomerTMSInfo getBorrowerInfo() {
        if (borrowerInfo == null) {
            borrowerInfo = new CustomerTMSInfo();
        }
        return borrowerInfo;
    }
