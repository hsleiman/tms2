...
import com.objectbrains.sti.db.entity.report.ReportSql;
import com.objectbrains.sti.exception.ReportNotFoundException;
import com.objectbrains.sti.pojo.report.AliasToBeanResultConverter;
import com.objectbrains.sti.pojo.report.AliasToEntityLinkedMapResultTransformer;
import com.objectbrains.sti.pojo.report.DialerRunAgentStats;
import com.objectbrains.sti.pojo.report.DialerRunStats;
import com.objectbrains.sti.pojo.report.DialerStatsReport;
import com.objectbrains.sti.pojo.report.TMSReportPojo;
import com.objectbrains.sti.pojo.report.TodaysAgentProductivity;
...
//        todaysAgentProductivityReportSql = IOUtils.toString(ResourceUtils.getURL("classpath:/com/objectbrains/sti/sql/TodaysAgentProductivityReports.sql"));
//        currentDialerServiceStatsSql = IOUtils.toString(ResourceUtils.getURL("classpath:/com/objectbrains/sti/sql/CurrentDialerServiceStatsForQueue.sql"));
//        dialerRunStatsSql = IOUtils.toString(ResourceUtils.getURL("classpath:/com/objectbrains/sti/sql/DialerRunStats.sql"));
//        dialerRunStatsForQueueSql = IOUtils.toString(ResourceUtils.getURL("classpath:/com/objectbrains/sti/sql/DialerRunStatsForQueue.sql"));
//        dialerRunAgentStatsSql = IOUtils.toString(ResourceUtils.getURL("classpath:/com/objectbrains/sti/sql/DialerRunAgentStats.sql"));
    }

    @PersistenceContext
    private EntityManager entityManager;

    public List<TMSReportPojo> getReports() {
        return entityManager.createQuery("select "
                + "new " + TMSReportPojo.class.getName() + "(report.pk, report.name) "
                + "from ReportSql report",
                TMSReportPojo.class).getResultList();
    }
