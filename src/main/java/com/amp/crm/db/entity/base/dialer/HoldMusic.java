...
@NamedQueries({
    @NamedQuery(
            name = "HoldMusic.GetAllHoldMusic",
            query = "SELECT s FROM HoldMusic s"
    ),
    @NamedQuery(
            name = "HoldMusic.GetHoldMusicByName",
            query = "SELECT s FROM HoldMusic s where LOWER(TRIM(s.fileName)) = LOWER(TRIM(:fileName))"
    )
})
@Entity
@Table(schema="sti")
public class HoldMusic extends SuperEntity {
    ...
    public boolean equals(Object obj) {
        ...
        final HoldMusic other = (HoldMusic) obj;
