...
import com.amp.tms.pojo.UploadCallRecordingPOJO;
...
public class CallDetailRecordService {
    ...
    public void addSpeechToText(Integer ext, com.amp.tms.websocket.message.inbound.SpeechToText speechToText) {
...
//        }
    ...
    @Async
    public void saveInitialMasterRecordIntoSVC(com.amp.crm.db.entity.base.dialer.CallDetailRecord callDetailRecordMaster) {
