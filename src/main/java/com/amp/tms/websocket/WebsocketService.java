...
import com.amp.crm.pojo.CallDispositionLogData;
...
import com.amp.tms.db.repository.CallDetailRecordRepository;
import com.amp.tms.db.repository.CdrRepository;
import com.amp.tms.db.repository.DialplanRepository;
import com.amp.tms.db.repository.WebsocketRepository;
...
import static com.amp.tms.enumerated.SetAgentState.IDLE;
import com.amp.tms.freeswitch.pojo.FreeswitchCommand;
import com.amp.tms.hazelcast.ListAdapter;
...
import com.amp.tms.service.freeswitch.PhoneOperationService;
...
import com.amp.tms.websocket.message.PhoneCheck;
import com.amp.tms.websocket.message.PhoneCheckData;
import com.amp.tms.websocket.message.PlayPrompt;
import com.amp.tms.websocket.message.inbound.CallDisposition;
import com.amp.tms.websocket.message.inbound.LockNextAvailable;
import com.amp.tms.websocket.message.inbound.Recieve;
import com.amp.tms.websocket.message.outbound.CallRecent;
import com.amp.tms.websocket.message.outbound.CallSipHeader;
import com.amp.tms.websocket.message.outbound.ChangeFreeswitchIp;
import com.amp.tms.websocket.message.outbound.PhoneToType;
import com.amp.tms.websocket.message.outbound.PushNotification;
...
//                    }
    ...
    private void sendDispositionLogToSvc(int ext, String callUUID, Long dispositionId, String log, AgentCall call) {
        ...
        if (call != null) {
            ...
            data.setCallDirection(com.amp.crm.constants.CallDirection.valueOf(call.getCallDirection().name()));
