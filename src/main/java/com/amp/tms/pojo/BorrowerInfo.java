 ...
 */
@Embeddable
public class BorrowerInfo implements DataSerializable, Serializable {
    ...
    public BorrowerInfo(Long loanId, String borrowerLastName, String borrowerFirstName, String borrowerPhoneNumber, String borrowerPhoneNumberType) {
        this.loanId = loanId;
    ...
    public BorrowerInfo(BorrowerInfo copy) {
