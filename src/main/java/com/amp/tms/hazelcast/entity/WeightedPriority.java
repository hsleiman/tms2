...
public class WeightedPriority implements DataSerializable {
    ...
    public WeightedPriority(com.amp.crm.embeddable.WeightedPriority weightedPriority) {
    ...
    public final void copyFrom(com.amp.crm.embeddable.WeightedPriority copy) {
